...
import { Home, Clock, Calendar as CalendarIcon, Users, UserCheck, UserX, ChevronDown, ChevronRight, Download, Upload, ClipboardCheck, Lock, LogOut, Plus, AlertTriangle } from "lucide-react";
...
export default function DGMDashboard() {
  ...
  const navItems = [
    ...
    { id: "status", label: "Attendance Status", icon: ClipboardCheck },
  ...
  const statusRows = [
    { id: "000111", dept: "Electrical", file: "Electrical_06/26.xlsx", uploaded: "11/06/2026", approvedBy: "000931", approvedOn: "11/06/2026", status: "A" },
    { id: "000112", dept: "Civil", file: "Civil_06/26.xlsx", uploaded: "12/06/2026", approvedBy: "000932", approvedOn: "12/06/2026", status: "P" },
    { id: "000113", dept: "Mechanical", file: "Mechanical_06/26.xlsx", uploaded: "13/06/2026", approvedBy: "000933", approvedOn: "13/06/2026", status: "A" },
    { id: "000114", dept: "IT", file: "IT_06/26.xlsx", uploaded: "13/06/2026", approvedBy: "000934", approvedOn: "13/06/2026", status: "P" },
    { id: "000115", dept: "CLI", file: "CLI_06/26.xlsx", uploaded: "14/06/2026", approvedBy: "000935", approvedOn: "14/06/2026", status: "A" },
  ];
  ...
  const Sidebar = () => (
    <div className="w-64 bg-white rounded-l-3xl flex flex-col py-6 px-4 relative overflow-hidden h-full">
      ...
      <div className="flex items-center gap-3 px-2 mb-6">
        <img src="https://i.pravatar.cc/40?img=33" alt="avatar" className="w-10 h-10 rounded-full object-cover" />
        <div>
          <div className="font-semibold text-sm text-gray-800">Rohan Mehta</div>
          <div className="text-xs text-gray-400">DGM</div>
        </div>
      </div>
  ...
  const TopBar = () => (
    <div className="flex justify-end items-center gap-4 mb-6 text-sm text-gray-500">
      ...
      <div className="flex items-center gap-2">
        <img src="https://i.pravatar.cc/40?img=33" alt="avatar" className="w-7 h-7 rounded-full object-cover" />
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm overflow-x-auto">
                ...
                <tbody>
                  {statusRows.map((row, idx) => (
                    <tr key={row.id} className={idx % 2 === 0 ? "bg-white" : "bg-gray-50"}>
                      ...
                      <td className="px-4 py-3 border-t border-gray-100">
                        <span
                          className={`inline-flex items-center justify-center w-7 h-7 rounded-md font-semibold text-white ${
                            row.status === "A" ? "bg-green-500" : "bg-red-500"
                          }`}
                        >
                          {row.status}
                        </span>
              ...
              <div className="flex items-center gap-4 mt-4 text-xs text-gray-500">
                <span className="flex items-center gap-1">
                  <span className="w-4 h-4 rounded bg-green-500 inline-block" /> A = Approved
                </span>
                <span className="flex items-center gap-1">
                  <span className="w-4 h-4 rounded bg-red-500 inline-block" /> P = Pending / Rejected
                </span>
              </div>
            </div>
          )}
